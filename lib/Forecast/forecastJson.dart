...
class Weather {
    ...
    factory Weather.fromJson(Map<String, dynamic> json) => Weather(
        ...
        iconn: iconValues.map[json["icon"]],
    );
    ...
    Map<String, dynamic> toJson() => {
        ...
        "icon": iconValues.reverse[iconn],
    };
}

enum Description { OVERCAST_CLOUDS, BROKEN_CLOUDS, LIGHT_RAIN, SCATTERED_CLOUDS }
...
enum Iconn { THE_04_D, THE_04_N, THE_10_D, THE_10_N, THE_03_D }
